...
namespace PlcCommunicationService.SystemPlc
{
    public class OutSignals : SignalWriter, IOutSignals
    {
            ...
            loggerFactory.CreateLogger<SignalWriter>())
        {
            ...
            InitSignals(reader);
            ExternalIO = new ExternalIO(channel, loggerFactory);
        }
        ...
        /// Sets the value of MoveRequestConfRead -> confirmation, that the move request conf was read.
        /// </summary>
        public async Task SetScanNotificationRead(bool value)
        {
            //get { return _MoveRequestConfRead; }
            await WriteVar(Declarations.NodePaths.ScanNotificationRead, value);
        }

        /// <summary>
        /// Sets the value of MoveRequestConfRead -> confirmation, that the move request conf was read.
        /// </summary>
        public ExternalIO ExternalIO { get; }
